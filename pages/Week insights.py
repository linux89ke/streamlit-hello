...
# Function to calculate insights for a specific week
...
if uploaded_file:
    ...
    # Rejection reasons
    if 'Rejection Reasons' in data.columns:
        st.subheader("Rejection Reasons Breakdown")
        rejection_reasons = data['Rejection Reasons'].value_counts()
        st.bar_chart(rejection_reasons)
    else:
        st.error("The column 'Rejection Reasons' is missing in the dataset.")
